...
class RepartidoresService:
    ...
    def importar_disponibilidad_desde_archivo(self, ruta):

        return ImportadorDisponibilidad(
            self.repartidores_repository
        ).importar(ruta)

    def importar_ausencias_desde_archivo(self, ruta):

        return ImportadorAusencias(
            self.repartidores_repository
        ).importar(ruta)
