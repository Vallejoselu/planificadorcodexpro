...
(c) 2026 Valle. Todos los derechos reservados.

Queda prohibida la copia, redistribucion, venta, modificacion o presentacion
como propia de esta aplicacion sin autorizacion expresa de Valle.
...
- Opciones avanzadas de repartidor ocultas por defecto para indicar solo
...
- Flujo guiado para trabajar por restaurantes concretos o por zonas
  generales sin crear cada local.
...
- Hoja semanal por empleado con fechas reales, colores suaves, horas valle,
  total semanal y complementarias en una misma tabla para revisar la cobertura
  de un vistazo.
