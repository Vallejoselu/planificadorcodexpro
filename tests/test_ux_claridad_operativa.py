...
class TestUxClaridadOperativa(unittest.TestCase):
    ...
    def test_puesta_marcha_explica_reinicio_limpio(self):
        ...
        self.assertEqual(vista.btn_crear_minimos.text(), "Crear datos minimos")
        self.assertIn("datos minimos", vista.guia.text().lower())
        self.assertIn("No crea repartidores", vista.btn_crear_minimos.toolTip())
